// =====================================================================
// test helper: statistical tests for randomness quality — uniformity
// and independence. Pure functions returning a statistic; tests assert
// the statistic is within the critical value for a fixed seed so they
// are always deterministic and never flaky.
//
// Ported from Lost-secuirty/Demo-math-slot-test-only (test/helpers/stats.js).
// =====================================================================
...
// Kolmogorov-Smirnov D statistic vs the uniform CDF.
// Critical value at the 5% level: ~1.36 / sqrt(n).
...
// |Z| < 1.96 indicates no systematic clustering at the 5% level.
