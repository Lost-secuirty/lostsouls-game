...
Short notes on the significant technical choices and *why* we made them. Scaffold a
...
| [0002](0002-topdown-singleplayer-first.md) | Top-down camera, single-player first (dad as AI ally) | Accepted |
