...
| **Meta-progression** | **Echoes** (residual boss energy) earned post-beat → spend in **Resonance** on permanent baseline buffs (`META_UPGRADES`); entire layer gated behind the first full win | `SAVES`, `META_UPGRADES`                                             | 0029                               |
